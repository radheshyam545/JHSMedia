    ...
    <nav className="text-white py-4 px-5 sm:px-8 flex items-center justify-center font-['Urbanist'] relative z-10">
      <div className="max-w-[1285px] w-full flex items-center justify-between">
        <div className="flex items-center ml-4 sm:ml-[200px]">
          <img src={logo} alt="JHS Media" className="h-[60px] sm:h-[100px] w-22 mr-4 sm:w-auto" />
        </div>
        <div className="flex items-center mr-4 sm:mr-[200px]">
          ...
          >
            <svg
              className={`w-6 h-6  ${isOpen ? 'text-white' : 'text-black'}`} // Keep text-white to ensure it stays white
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          {/* Desktop Menu */}
          <ul className={`hidden sm:flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-[55px] ml-4 sm:ml-0 text-black`}>
